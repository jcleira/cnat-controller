...
import (
	...
	cnatcontroller "k8s.io/sample-controller/pkg/apis/cnat/v1alpha1"
...
func newFoo(name string, replicas *int32) *cnatcontroller.Foo {
	return &cnatcontroller.Foo{
		TypeMeta: metav1.TypeMeta{APIVersion: cnatcontroller.SchemeGroupVersion.String()},
		ObjectMeta: metav1.ObjectMeta{
			Name:      name,
			Namespace: metav1.NamespaceDefault,
		},
		Spec: cnatcontroller.FooSpec{
...
func (f *fixture) expectUpdateFooStatusAction(foo *cnatcontroller.Foo) {
...
func getKey(foo *cnatcontroller.Foo, t *testing.T) string {
